...
/**
 * Lightweight inline-SVG icon set (Lucide paths) so the app has no external
 * icon-registration boilerplate. Add new icons to PATHS as needed.
 */
type IconName =
  | 'layout-dashboard'
  | 'calculator'
...
const PATHS: Record<IconName, string> = {
  ...
  'sticky-note':
    '<path d="M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11l5-5V5a2 2 0 0 0-2-2z"/><path d="M15 3v6h6"/>',
  'credit-card':
  ...
  wallet:
    '<path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4"/><path d="M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4"/><path d="M18 12a2 2 0 0 0 0 4h4v-4Z"/>',
  'refresh-cw':
