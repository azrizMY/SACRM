...
export const VEHICLES: Vehicle[] = [
  ...
  { id: 'proton-saga-premium', brand: 'Proton', model: 'Saga', variant: 'Premium', price: 49990, photoUrl: '/cars/proton-saga.png', brochureUrl: '/brochures/proton-saga.pdf', years: [{ year: 2026 }] },
  ...
  { id: 'proton-s70-executive', brand: 'Proton', model: 'S70', variant: 'Executive', price: 73800, photoUrl: '/cars/proton-s70.png', brochureUrl: '/brochures/proton-s70.pdf', years: [{ year: 2026 }] },
  { id: 'proton-s70-premium', brand: 'Proton', model: 'S70', variant: 'Premium', price: 79800, photoUrl: '/cars/proton-s70.png', brochureUrl: '/brochures/proton-s70.pdf', years: [{ year: 2026 }] },
  { id: 'proton-s70-flagship', brand: 'Proton', model: 'S70', variant: 'Flagship', price: 89800, photoUrl: '/cars/proton-s70.png', brochureUrl: '/brochures/proton-s70.pdf', years: [{ year: 2026 }] },
  { id: 'proton-s70-flagship-x', brand: 'Proton', model: 'S70', variant: 'Flagship X', price: 94800, photoUrl: '/cars/proton-s70.png', brochureUrl: '/brochures/proton-s70.pdf', years: [{ year: 2026 }] },
  { id: 'proton-x50-executive', brand: 'Proton', model: 'X50', variant: 'Executive', price: 89800, photoUrl: '/cars/proton-x50.png', brochureUrl: '/brochures/proton-x50.pdf', years: [{ year: 2026 }] },
  { id: 'proton-x50-premium', brand: 'Proton', model: 'X50', variant: 'Premium', price: 101800, photoUrl: '/cars/proton-x50.png', brochureUrl: '/brochures/proton-x50.pdf', years: [{ year: 2026 }] },
  { id: 'proton-x50-flagship', brand: 'Proton', model: 'X50', variant: 'Flagship', price: 113300, photoUrl: '/cars/proton-x50.png', brochureUrl: '/brochures/proton-x50.pdf', years: [{ year: 2026 }] },
  { id: 'proton-x70-executive', brand: 'Proton', model: 'X70', variant: 'Executive', price: 106800, photoUrl: '/cars/proton-x70.png', brochureUrl: '/brochures/proton-x70.pdf', years: [{ year: 2026 }] },
  { id: 'proton-x70-premium', brand: 'Proton', model: 'X70', variant: 'Premium', price: 119800, photoUrl: '/cars/proton-x70.png', brochureUrl: '/brochures/proton-x70.pdf', years: [{ year: 2026 }] },
  { id: 'proton-x90-lite', brand: 'Proton', model: 'X90', variant: 'Lite', price: 106800, photoUrl: '/cars/proton-x90.png', brochureUrl: '/brochures/proton-x90.pdf', years: [{ year: 2026 }] },
  { id: 'proton-x90-prime', brand: 'Proton', model: 'X90', variant: 'Prime', price: 116800, photoUrl: '/cars/proton-x90.png', brochureUrl: '/brochures/proton-x90.pdf', years: [{ year: 2026 }] },
  { id: 'proton-x90-prime-x', brand: 'Proton', model: 'X90', variant: 'Prime X', price: 122800, photoUrl: '/cars/proton-x90.png', brochureUrl: '/brochures/proton-x90.pdf', years: [{ year: 2026 }] },
  ...
  { id: 'chery-o5-1-5t', brand: 'Chery', model: 'Chery O5', variant: '', price: 116800, interestRate: 2.3, basicPremium: 2789.07, addBenefits: 715.5, photoUrl: '/cars/chery-o5.png', brochureUrl: '/brochures/chery-o5.pdf', years: [{ year: 2026 }] },
  ...
  { id: 'chery-tiggo-cross-turbo', brand: 'Chery', model: 'Tiggo Cross', variant: 'Turbo', price: 88800, interestRate: 2.3, basicPremium: 2206.67, addBenefits: 620.5, photoUrl: '/cars/chery-tiggo-cross-turbo.png', brochureUrl: '/brochures/chery-tiggo-cross.pdf', years: [{ year: 2026 }] },
  { id: 'chery-tiggo-cross-hev', brand: 'Chery', model: 'Tiggo Cross', variant: 'Hybrid', price: 99800, interestRate: 2.3, basicPremium: 2435.47, addBenefits: 642.5, photoUrl: '/cars/chery-tiggo-cross-hybrid.png', brochureUrl: '/brochures/chery-tiggo-cross.pdf', years: [{ year: 2026 }] },
  { id: 'chery-tiggo7-pro', brand: 'Chery', model: 'Tiggo 7', variant: 'Pro', price: 123800, interestRate: 2.3, basicPremium: 2934.67, addBenefits: 820.5, photoUrl: '/cars/chery-tiggo7-pro.png', brochureUrl: '/brochures/chery-tiggo7-pro.pdf', years: [{ year: 2026 }] },
  { id: 'chery-tiggo7-phev', brand: 'Chery', model: 'Tiggo 7', variant: 'PHEV', price: 129800, interestRate: 2.3, basicPremium: 3088.44, addBenefits: 832.5, photoUrl: '/cars/chery-tiggo7-phev.png', brochureUrl: '/brochures/chery-tiggo7-phev.pdf', years: [{ year: 2026 }] },
  { id: 'chery-tiggo8-1-6t', brand: 'Chery', model: 'Tiggo 8', variant: '', price: 129800, interestRate: 2.3, basicPremium: 3059.47, addBenefits: 832.5, photoUrl: '/cars/chery-tiggo8.png', brochureUrl: '/brochures/chery-tiggo8.pdf', years: [{ year: 2026 }] },
